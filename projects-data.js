...
const projectsData = {
  // ========== Work Experience ==========
  "descente-social": {
    title: "Descente SNS Promotion Design",
    titleKr: "Descente SNS Promotion Design",
    date: "2025.03-08",
    director: "Soojung Kim",
    directorKr: "김수정",
    desc: "Visuals were created for Descente Korea’s social media, along with content for various digital platforms. The images were adapted from the key visuals of an existing promotional exhibition.",
    descKr:
  ...
  "descente-exhibition": {
    ...
    title: "Descente Seasonal Exhibition",
    titleKr: "Descente Seasonal Exhibition",
    date: "2025.05",
    desc:
  ...
  */
  ...
  "iap-residency": {
    title: "IAP Residency 《VITA NOVA_New Life》",
    titleKr: "IAP Residency 《VITA NOVA_New Life》",
    date: "2022",
    client:
  ...
  "jade-sujin-lee": {
    title: "Jade Sujin Lee 《CHANGE OR TRANS-HIKING》",
    titleKr: "이수진 작가 《돌과 유리 하이킹》",
    date: "2022",
    client:
  ...
  "we-refuse-to-be-comfortable": {
    title: "We refuse to be comfortable",
    titleKr: "We refuse to be comfortable",
    date: "2026.05",
    medium:
      "Printed matter, 148 × 210 mm (5.83 × 8.27 in) <br>3D printing cover, Pearl PLA",
    mediumKr:
      "인쇄물, 148 × 210 mm (5.83 × 8.27 in) <br>3D 프린팅 커버, 펄 PLA",
    advisor: "Karen Dunn",
    advisorKr: "Karen Dunn",
    collaborator: "Yiling Yang, Binjia Li",
    collaboratorKr: "Yiling Yang, Binjia Li",
    desc: "A team manifesto and zine arguing that friction is not a failure of design but its condition. It pushes back against the assumption that good design should feel effortless, that smoothness is neutral, and that beauty standards are natural rather than constructed. The cover is 3D printed, departing from standard book conventions to give the object physical height and presence. Inner pages use a three-part structure, with each section dedicated to an individual project from one team member. At the back, the three sections converge into a single shared spread where the team manifesto is presented together. The form itself enacts the argument: meaning does not emerge from comfort or consensus, but from friction, difference, and the moment of encounter between distinct voices.",
    descKr:
      "마찰이 디자인의 실패가 아니라 조건임을 주장하는 팀 매니페스토와 진. 좋은 디자인은 힘이 들지 않아야 한다는 가정, 매끄러움은 중립적이라는 전제, 그리고 뷰티의 기준이 만들어진 것이 아니라 자연스러운 것이라는 통념에 반대한다. 표지는 3D 프린팅으로 제작되어 일반적인 책의 형식에서 벗어나 물리적인 높이와 존재감을 갖는다. 내지는 3분할 구조로 각 섹션이 팀원 개인의 프로젝트를 담고, 마지막 섹션에서 세 파트가 하나의 페이지로 합쳐지며 팀 매니페스토를 함께 전개한다. 형식 자체가 매니페스토의 논증을 실천한다. 의미는 편안함이나 합의에서 나오는 것이 아니라, 마찰과 차이, 그리고 서로 다른 목소리들이 만나는 순간에서 시작된다.",
    thumbnail: "images/we-refuse-to-be-comfortable/thumb.webp",
    media: [
      "full:images/we-refuse-to-be-comfortable/01.webp",
      "col2:images/we-refuse-to-be-comfortable/02-1.webp",
      "col2:images/we-refuse-to-be-comfortable/02-2.webp",
      "full:images/we-refuse-to-be-comfortable/03.webp",
      "col2:images/we-refuse-to-be-comfortable/04-1.webp",
      "gif:col2:images/we-refuse-to-be-comfortable/04-2.mp4",
      "col2:images/we-refuse-to-be-comfortable/05-1.webp",
      "col2:images/we-refuse-to-be-comfortable/05-2.webp",
      "full:images/we-refuse-to-be-comfortable/06.webp",
  ...
  "by-meesh": {
    ...
    awardKr:
      '<a href="https://welcometochinatown.com/" target="_blank">Welcome to Chinatown</a> 2026 Tech Hackathon, 1등',
    desc: "By Meesh is an integrated catering management platform designed to streamline the entire event workflow. Previously, tasks such as client inquiries, menu planning, inventory tracking, proposal creation, and invoicing relied on fragmented tools and repetitive manual processes, making the workflow inefficient and difficult to scale. This project was designed to unify those disconnected systems into a single platform that supports a more intuitive and efficient operational process. Customers can submit event requests through a booking interface, while operators manage menu curation, cost calculation, inventory tracking, supplier coordination, proposals, and invoicing through a centralized back-office dashboard. The platform also visualizes the workflow between customers, operators, and suppliers, creating a connected system that supports the full process from event preparation to on-site execution.",
    descKr:
  ...
  */
  "against-smoothness": {
    ...
    date: "2026.05",
    medium:
      "Printed matter, 4 × 46.125 in <br>Single-channel video, 1920 × 1080 px <br>Interactive prototype, Arduino Uno with rotary encoder, Python server, Chrome extension",
    mediumKr:
      "인쇄물, 4 × 46.125 in <br>싱글 채널 비디오, 1920 × 1080 px <br>인터랙티브 프로토타입, 아두이노 우노 + 로터리 엔코더, 파이썬 서버, 크롬 익스텐션",
    advisor: "Diego Kolsky, Liubomir Borissov",
    advisorKr: "Diego Kolsky, Liubomir Borissov",
    desc: "Against Smoothness is a thesis research project exploring what happens to perception when smoothness is interrupted. Smooth systems are designed to keep behavioral data extraction invisible. This research asks whether designed friction can restore the awareness that smoothness suppresses.\n\nThe thesis pamphlet is printed on a 4 inch wide strip of paper wound around a cylindrical core, a scroll you have to physically unwind to read. Friction As Interface extends the thesis into a physical prototype: a rotary encoder knob replaces finger scrolling on an Instagram feed. As speed increases, the LED shifts from green to red, the content blurs, and the algorithm's reasoning appears as text overlays, making visible what the smooth interface was built to conceal.",
    descKr:
      "Against Smoothness는 smoothness가 중단되었을 때 인식에 어떤 일이 일어나는지를 탐구하는 thesis research 프로젝트입니다. 매끄러운 시스템은 행동 데이터 추출을 사용자에게 보이지 않게 만들도록 설계되어 있습니다. 이 연구는 설계된 마찰이 smoothness가 억제하는 인식을 되살릴 수 있는지를 묻습니다.\n\nthesis 팜플렛은 가로 4인치의 종이 띠를 원통형 코어에 감은 두루마리 형태로, 직접 펼쳐야 읽을 수 있습니다. Friction As Interface는 thesis를 물리적 프로토타입으로 구현한 실험입니다. 로터리 엔코더 노브가 인스타그램 피드의 스크롤링을 대체하며, 속도가 빨라질수록 LED가 초록에서 빨간색으로 바뀌고 콘텐츠가 흐려지면서 알고리즘의 논리가 텍스트로 드러납니다.",
    ...
    media: [
      ...
      "full:images/against-smoothness/04.mp4::Experiment Video",
      "gif:col2:images/against-smoothness/04-1.mp4",
      "gif:col2:images/against-smoothness/04-2.mp4",
      "col2:images/against-smoothness/05-1.webp",
      "col2:images/against-smoothness/05-2.webp",
      "col2:images/against-smoothness/06-1.webp",
      "col2:images/against-smoothness/06-2.webp",
    ],
  },
  "other-islands": {
    title: "Other islands Book Fair 2026 (Proposal)",
    titleKr: "Other islands Book Fair 2026 (제안안)",
    date: "2025.11",
    medium:
      "Printed matter, 11 × 17 in (279 × 432 mm), vertical and horizontal <br>Single-channel video, 1920 × 1080 px",
    mediumKr:
      "인쇄물, 11 × 17 in (279 × 432 mm), 세로형 및 가로형 <br>싱글 채널 비디오, 1920 × 1080 px",
    collaborator: "Seulgi Choi, Chiho Ye",
    collaboratorKr: "최슬기, Chiho Ye",
    desc: "Other Islands Book Fair 2026 is a project that visualizes the book fair as a temporary gathering and exchange, using *Bird Migration* as a metaphor for movement, connection, and return. Inspired by the routes and traces of migratory birds, the visual system is built from modular dot forms that express both individuality and collectivity through repetition, variation, and motion. A nature-derived color palette and a flexible logo structure reinforce this concept, while the identity is applied across posters, signage, motion graphics, social media, and merchandise to convey the rhythm of convergence and dispersal that defines the book fair experience.",
    descKr:
  ...
  palindrome: {
    title: "Palindrome s emordnilaP",
    titleKr: "Palindrome s emordnilaP",
    date: "2024.11",
    medium:
      "Single-channel video, 00:01:45 <br>Printed matter, 160 × 140 mm (6.3 × 5.5 in), 94p, Screw binding <br>Virtual object, 500 × 350 × 500 mm (19.6 × 13.7 × 19.6 in)",
    mediumKr:
      "싱글 채널 비디오, 00:01:45 <br>인쇄물, 160 × 140 mm (6.3 × 5.5 in), 94p, 스크류 바인딩 <br>가상 오브제, 500 × 350 × 500 mm (19.6 × 13.7 × 19.6 in)",
  ...
  imoa: {
    title: "Intangible Museum Of Art (I-MOA)",
    titleKr: "Intangible Museum Of Art (I-MOA)",
    date: "2022.02",
    medium: "Brand identity, Video, Editorial",
    mediumKr: "브랜드 아이덴티티, 영상, 에디토리얼",
    advisor: "Seon-A Lim",
    advisorKr: "임선아",
  ...
  ilmin: {
    title: "Ilmin Museum of Art Rebranding (Proposal)",
    titleKr: "일민미술관 리브랜딩 (제안안)",
    date: "2020.06",
    medium: "Printed matter, 297 × 210 mm (11.7 × 8.3 in), 110p, Pur binding",
    mediumKr: "인쇄물, 297 × 210 mm (11.7 × 8.3 in), 110p, PUR 바인딩",
    advisor: "Namoo Kim",
    advisorKr: "김나무",
    collaborator: "Gyeoryei Lee, Seoyoon Byun",
    collaboratorKr: "이겨례, 변서윤",
    desc: "This project is a virtual rebranding of Ilmin Museum of Art. Conceived as a space for dialogue where organic communication can unfold, the diverse perspectives within the museum generate multiple interpretations and give rise to new paradigms. To encompass this process, the project adopts the symbolic and visual aspects of parentheses, demonstrating how the questions posed through Ilmin Museum of Art can be understood through multiple interpretations and contexts.",
    descKr:
  ...
  "running-back": {
    title: "Running Back Again",
    titleKr: "Running Back Again",
    date: "2020.01",
    medium:
      "Printed matter, 210 × 148 mm (8.3 × 5.8 in), 216p, Hardcover book with Swiss binding",
    mediumKr:
      "인쇄물, 210 × 148 mm (8.3 × 5.8 in), 216p, 스위스 바인딩 하드커버 북",
    advisor: "Hyunho Choi",
    advisorKr: "최현호",
  ...
  // ========== Experiment ==========
  "coral-layered-memory": {
    title: "Coral Layered Memory",
    titleLink: "https://hjeon113.github.io/coral/",
    titleKr: "Coral Layered Memory",
    date: "2026.04",
    medium: "Interactive web <br>3D printing, transparent PLA",
    mediumKr: "인터랙티브 웹 <br>3D 프린팅, 투명 PLA",
    advisor:
      '<a href="https://josephburwell.com/" target="_blank">Joseph Burwell</a>',
    advisorKr:
      '<a href="https://josephburwell.com/" target="_blank">Joseph Burwell</a>',
    desc: "Coral accumulates time in its body. Polyps build skeletons, the next generation grows on top, then the next. A coral reef is the result of this repetition, an architecture produced without intention. Coral Layered Memory translates that logic of accumulation into form: the way five coral species occupy space is extracted as a structural diagram for each, then rendered as a 3D ribbon sculpture.\n\nPlatygyra (brain coral) navigates space through sinuous, meandering movement. Its labyrinthine valley structure becomes the ribbon's path, shifting direction gradually, layer by layer. Acropora (staghorn coral) branches unpredictably, colonizing space through irregular impulse, with the most dramatic shifts between layers. Galaxea (star coral) spreads with bilateral symmetry, expanding evenly around a central axis. The horizontal axis holds fixed while the ribbon oscillates vertically, balanced and measured. Turbinaria (pagoda coral) grows flat and wide, the thinnest and most lateral of the five, extending horizontally to cover space by area rather than height. Fungia (mushroom coral) exists alone. It is the only solitary polyp among the five, forming no colony and able to move across the seafloor. The ribbon sways rhythmically side to side, holding that solitary drift.\n\nOf the five, three species with the most formally distinct structures, Platygyra, Turbinaria, and Galaxea, were selected for 3D fabrication.",
    descKr:
      "산호는 자신의 몸에 시간을 축적한다. 폴립이 골격을 만들고, 다음 세대가 그 위에 자라며, 또 그 위에 다음 세대가 자란다. 산호초는 이 반복이 만들어낸 결과물, 의도 없이 만들어진 건축이다. Coral Layered Memory는 이 축적의 논리를 형태로 번역한 작업으로, 다섯 종의 산호가 공간을 점유하는 방식을 각각의 구조적 다이어그램으로 추출해 3D 리본 조각으로 구현한다.\n\nPlatygyra(뇌산호)는 구불구불하게 굽이치는 움직임으로 공간을 탐색한다. 미로 같은 골짜기 구조가 리본의 경로가 되어, 층층이 방향을 점진적으로 바꾸며 나아간다. Acropora(가지산호)는 불규칙한 충동으로 예측 불가능하게 분기하며 공간을 점령한다. 리본은 그 분열의 충동을 따라가며, 층 사이에서 가장 극적인 변화를 만든다. Galaxea(별산호)는 중심축을 기준으로 좌우 대칭으로 고르게 확산한다. 가로축이 고정된 상태에서 리본은 세로축을 따라 진동하며, 균형 잡히고 측정된 형태를 그린다. Turbinaria(파고다산호)는 다섯 종 중 가장 얇고 가장 수평적인 종으로, 높이보다 면적으로 공간을 덮으며 가로로 뻗어나간다. Fungia(버섯산호)는 홀로 존재한다. 다섯 종 중 유일하게 군체를 이루지 않고 해저를 자유롭게 이동할 수 있는 단독성 폴립이다. 리본은 좌우로 리드미컬하게 흔들리며 그 고독한 떠돎을 담는다.\n\n다섯 종 중 형태적으로 가장 뚜렷이 구분되는 세 종, Platygyra, Turbinaria, Galaxea를 3D 제작 대상으로 선정했다.",
    thumbnail: "images/coral-layered-memory/thumb.webp",
    media: [
      "iframe:https://hjeon113.github.io/coral/",
      "col3:images/coral-layered-memory/01-1.webp",
      "col3:images/coral-layered-memory/01-2.webp",
      "col3:images/coral-layered-memory/01-3.webp",
      "col2:images/coral-layered-memory/02-1.webp",
      "col2:images/coral-layered-memory/02-2.webp",
      "full:images/coral-layered-memory/03.webp",
      //"col2:images/coral-layered-memory/04-1.webp",
      //"col2:images/coral-layered-memory/04-2.webp",
      //"col3:images/coral-layered-memory/05-1.webp",
      //"col3:images/coral-layered-memory/05-2.webp",
      //"col3:images/coral-layered-memory/05-3.webp",
      "full:images/coral-layered-memory/06.mp4",
    ],
  },
  "hype-slider": {
    title: "Hype Slider",
  ...
  "gesture-archive": {
    ...
    titleKr: "제스쳐 아카이브",
    date: "2025.12",
    medium: "Interactive web, p5.js, ml5.js",
    mediumKr: "인터랙티브 웹, p5.js, ml5.js",
    advisor:
      '<a href="https://www.mattiacasalegno.net/" target="_blank">Mattia Casalegno</a>',
    advisorKr:
      '<a href="https://www.mattiacasalegno.net/" target="_blank">Mattia Casalegno</a>',
    desc: "Gesture Archive is a web-based drawing system that translates hand movements into lines, dots, and visual traces through real-time tracking. Participants perform gestures with the intention of forming specific shapes, yet the system does not interpret meaning—it records only movement data such as speed, direction, and tremor. As a result, the marks that appear on the screen diverge from the intended image, revealing how digital systems perceive and process human expression differently. Gesture Archive treats this mismatch not as an error but as a generative condition, exploring how gestures transform through computational processes to produce new visual forms beyond original intention.",
    descKr:
  ...
  "question-imagination": {
    title: "Questions for people with imagination malnutrition",
    titleKr: "상상력 영양실조에 걸린 사람들에게 던지는 질문",
    date: "2023.03",
    medium: "Printed matter, Video",
    mediumKr: "인쇄물, 영상",
    advisor: "Namoo Kim",
    advisorKr: "김나무",
    desc: "In an era of information overload, we are gradually losing the ability to think for ourselves. Drawing from four books — Metaverse (by Sang-kyun Kim), The Blank Slate (by Steven Pinker), Sapiens (by Yuval Noah Harari), and Imagination and Gaston Bachelard (by Myung-hee Hong) — four team members investigated what qualities remain uniquely human in a world increasingly shaped by technology and automation. The resulting publication takes the form of an editorial experiment: a series of open-ended questions with no right answers and no fixed direction, designed to provoke reflection and reawaken an imagination that has long gone unused.",
    descKr:
